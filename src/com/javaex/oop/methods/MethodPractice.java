...
//		System.out.println(getSum());
		...
		// 문제5
		/*
		 * System.out.print("정수를 하나 입력하세요: "); Scanner scanner = new Scanner(System.in);
		 * int num2 = scanner.nextInt(); printOddOrEven(num2);
		 * 
		 * 
		 * // 문제6 System.out.print("문자열을 입력하세요: "); String word = scanner.next();
		 * printStringLength(word);
		 * 
		 * 
		 * // 문제7 System.out.println("서로 다른 두 정수를 입력하세요"); int num4 = scanner.nextInt();
		 * int num5 = scanner.nextInt(); System.out.println("둘 중 더 큰수는? " +
		 * getLargeNumber(num4, num5));
		 * 
		 * // 문제8 System.out.println("문자열 두 개를 입력하세요"); String word3 = scanner.next();
		 * String word4 = scanner.next(); System.out.println(concatenateStrings(word3,
		 * word4));
		 * 
		 * scanner.close();
		 */
